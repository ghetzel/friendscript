...
func (self *Commands) Get(key string, args *GetArgs) (any, error) {
	if args == nil {
		args = &GetArgs{}
	}
...
func (self *Commands) Set(key string, args *SetArgs) (any, error) {
	if args == nil {
		args = &SetArgs{}
	}
...
func (self *Commands) Pop(key string) (any, error) {
	var value any
